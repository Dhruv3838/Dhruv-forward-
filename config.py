...
class Config:
    ...
    BOT_TOKEN = environ.get("8257631750:AAGB7rQ1xjlFrmihAJxjvIMmqoJMv29iCn0", "8257631750:AAGB7rQ1xjlFrmihAJxjvIMmqoJMv29iCn0") 
    ...
    BOT_OWNER = int(environ.get("BOT_OWNER", "7824145158"))
